...
bash -n "$SCRIPTS_DIR/confirm-production-upgrade.sh"
...
bash -n "$TESTS_DIR/test-confirm-production-upgrade.sh"
bash -n "$TESTS_DIR/test-finalize-post-confirmation.sh"
bash -n "$TESTS_DIR/test-finalize-superseded.sh"
...
bash "$TESTS_DIR/test-confirm-production-upgrade.sh"
bash "$TESTS_DIR/test-finalize-post-confirmation.sh"
bash "$TESTS_DIR/test-finalize-superseded.sh"
